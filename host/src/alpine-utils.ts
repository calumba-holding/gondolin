...
import { assertSafeWritePath } from "./alpine-rootfs";
...
export function copyExecutable(src: string, dest: string, rootDir?: string): void {
  if (rootDir) {
...
export function injectBeforeSandboxdExec(script: string, snippet: string): string {
